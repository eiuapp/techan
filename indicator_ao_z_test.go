...
func TestAwesomeOscillatorIndicator_Calculate(t *testing.T) {
	typicalPrices := []string{
		...
		"24.10", "24.31", "24.47", "24.62", "24.46",
		// "24.37", "24.41", "24.25", "23.75", "24.19",
	}

	series := mockTimeSeries(typicalPrices...)

	ao := NewAOIndicator(series, 5, 34)

	results := []string{"101.9185", "31.1946", "6.5578", "33.6078", "34.9686", "13.6027",
		"-10.6789", "-11.4710", "-29.2567", "-128.6000", "-72.7273"}

	for i, result := range results {
		assert.EqualValues(t, result, ao.Calculate(i+33).FormattedString(4))
	}
}
